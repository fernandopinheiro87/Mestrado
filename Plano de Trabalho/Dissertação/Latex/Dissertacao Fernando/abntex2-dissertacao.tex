...
\include{apendiceA} %Questionário de Coleta de Dados
% ---
%\include{apendiceB} %Questionário e Resuldados de Avaliação
% ---
%\include{apendiceC} %Relatório quantitativo
% ---
%\begin{landscape}
%\include{apendiceD} %Respostas dissertativas
% ---
%\end{landscape}
%\include{apendiceE} %Códigos extraídos das respostas
% ---
%\include{apendiceF} %Notas MA
% ---
%\include{apendiceG} abortei o apêndice G pois as categorias já estão listadadas no apêndice E.
% ---
%\include{apendiceH} %que na verdade é o novo apêndice G: lista as notas OC e seus respectivos conteúdos
% ---
%\include{apendiceI} %que na verdade é o novo apêndice H: lista as notas AC e seus respectivos conteúdos
% ---
%\include{apendiceJ}
