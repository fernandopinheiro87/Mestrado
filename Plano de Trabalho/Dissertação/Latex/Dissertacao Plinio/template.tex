...
\documentclass[oneside]{ufpethesis}
...
\title{Ainda Não Tenho um Título}
...
\author{Plinio Antunes Garcia}

% Orientador(a)
% Opção: [f] - para orientador do sexo feminino
% e.g. \adviser[f]{Profa. Dra. Maria Santos}
\adviser{Prof. Dr. Vinicius Cardoso Garcia}
...
%@to-do: dar um jeito de trocar o 'and' por 'e' na bibliografia. Pesquisar como colocar bibliografia em pt-br
